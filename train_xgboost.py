...
# === DEFINE XGBOOST AND GRID SEARCH ===
param_grid = {
...
clf = GridSearchCV(estimator=xgb, param_grid=param_grid, cv=StratifiedKFold(n_splits=5), scoring='balanced_accuracy', verbose=1, n_jobs=-1)
...
joblib.dump(best_model, "models/v5/v5_classifier.pkl")
...
def evaluate_per_domain(df_full, X_all, y_all, y_pred_all, y_proba_all, domain_column):
    ...
    path = r"D:\dl\MIDOG_2025_Track_2\models\v5"
